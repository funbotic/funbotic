    ...
    <h2 class="nav-tab-wrapper"><?php _e( 'Login Customization', $this->plugin_name );?></h2>
        ...
        <p><?php _e( 'Add logo to login form.  Change buttons and background color.', $this->plugin_name ); ?></p>
            ...
            <fieldset>
                ...
                <div id="upload_logo_preview" class="funbotic-upload-preview <?php if ( empty( $login_logo_id ) ) echo 'hidden' ?>">
                    <img src="<?php echo $login_logo_url; ?>" />
                    <button id="funbotic-delete_logo_button" class="funbotic-delete-image">X</button>
                </div>
            </fieldset>

            <!-- Login background color. -->
            <fieldset class="funbotic-admin-colors">
